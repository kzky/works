...
from meta_recon.losses import ReconstructionLoss, LSGANLoss, GANLoss, EntropyRegularizationLoss, InvariantReconstructionLoss
...
class Experiment000(object):
    ...
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, n_cls=10):
        ...
        # Model
        from meta_recon.mnist.cnn_model_000 import Encoder, MLP, Decoder

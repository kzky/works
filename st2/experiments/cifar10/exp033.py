...
import time
import argparse
from st2.cifar10.cnn_model_033 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization
...
- Uncertainty for SR loss using ESD
- Uncertainty for ER loss
- Not using softmax before squared_error
- Squared error between uncertainty (sigma) and one, sigma becmoes one at the end.
"""

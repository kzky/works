...
import time
import argparse
from st2.cifar10.cnn_model_046 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization
...
- Uncertainty for CE
- Squared error between uncertainty (sigma square) and one, sigma becmoes one at the end. Applied for CE loss also.
- Separate solver
"""
...
def main(args):
    ...
    loss_supervised = loss_ce + er_loss(ctx, pred) + reg_sigma

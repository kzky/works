...
def main(args):
    ...
    pred = cnn_model_003(ctx, x_l, cnt=cnt); cnt += 1
    ...
    pred_x_u0 = cnn_model_003(ctx, x_u0, cnt=cnt); cnt += 1
    pred_x_u1 = cnn_model_003(ctx, x_u1, cnt=cnt)
    ...
    pred_eval = cnn_model_003(ctx, x_eval, test=True, cnt=cnt)

...
import time
import argparse
from st2.cifar10.cnn_model_058 import ce_loss, sr_loss, er_loss, cifar10_resnet23_prediction, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization
...
def main(args):
    ...
    pred, log_var = cifar10_resnet23_prediction(ctx, x_l)
    ...
    pred_x_u0, log_var0 = cifar10_resnet23_prediction(ctx, x_u0)
    pred_x_u1, log_var1 = cifar10_resnet23_prediction(ctx, x_u1)
    ...
    pred_eval, _ = cifar10_resnet23_prediction(ctx, x_eval, test=True)

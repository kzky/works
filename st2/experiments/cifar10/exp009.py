...
import time
import argparse
from st2.cifar10.cnn_model_009 import cnn_model_003, ce_loss, sr_loss, er_loss, \
    GradScaleContainer
...
- Naive implementation for gradient scaling; basis is grad scale of unsupervised loss
- Solver is separated
"""

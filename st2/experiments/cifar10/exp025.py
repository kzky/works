...
import time
import argparse
from st2.cifar10.cnn_model_025 import cnn_model_003, cnn_model_003_with_cross_attention, ce_loss, sr_loss, er_loss
...
def main(args):
    ...
    pred_x_u0, pred_x_u1 = \
                           cnn_model_003_with_cross_attention(ctx, [x_u0, x_u1])

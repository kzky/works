...
import time
import argparse
from st2.cifar10.cnn_model_067 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization
...
def main(args):
    ...
    one = F.constant(1. / np.sqrt(2.), log_var.shape)

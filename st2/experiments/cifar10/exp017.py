...
import time
import argparse
from st2.cifar10.cnn_model_017 import cnn_model_003, ce_loss, sr_loss, er_loss
...
- Seaprate unsupervsed loss update
"""
...
def main(args):
    ...
    for i in range(n_iter):
        ...
        solver.update()
        ## sr loss for recon
        loss_unsupervised_rc.forward(clear_no_need_grad=True)
        solver.zero_grad()
        loss_unsupervised_rc.backward(clear_buffer=True)
        solver.update()

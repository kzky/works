...
import time
import argparse
from st2.cifar10.cnn_model_010 import cnn_model_003, ce_loss, sr_loss, er_loss, \
    GradScaleContainer
...
- all ER losses are added to unsupervised loss.
"""
...
def main(args):
    ...
    loss_unsupervised = loss_sr + loss_er0 + loss_er1 + loss_er

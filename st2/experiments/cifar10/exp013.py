...
import time
import argparse
from st2.cifar10.cnn_model_008 import cnn_model_003, ce_loss, sr_loss, er_loss, \
    GradScaleContainer
...
- Gradient scaling; basis is grad scale of supervised loss but exponentially accumulated
- Solver is separated
"""

...
import time
import argparse
from st2.cifar10.cnn_model_051 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization
...
def main(args):
    ...
    loss_unsupervised = loss_sr + er_loss(ctx, pred_x_u0) + er_loss(ctx, pred_x_u1) + lambda_ * reg_sigmas
                        #+ 0. * (reg_sigma0 + reg_sigma1) + 
    ## evaluate

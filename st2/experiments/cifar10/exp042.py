...
import time
import argparse
from st2.cifar10.cnn_model_042 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization
...
def main(args):
    ...
    one = F.constant(1., (log_var.shape[0], ))

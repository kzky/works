...
import time
import argparse
from st2.cifar10.cnn_model_062 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization, cifar10_resnet23_prediction, kl_divergence
...
- Transfer knowledge to ResNet23 w/ temperature inverse
"""

...
import time
import argparse
from st2.cifar10.cnn_model_064 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization
...
- Squared error between uncertainty (sigma) and one, sigma becmoes one at the end. Applied for CE loss also. Omit 0.5 multiplication, resulting in conventional Stochastic Regularization

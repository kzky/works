...
import time
import argparse
from st2.svhn.cnn_model_051_002 import cnn_model_003, ce_loss, sr_loss, er_loss, sr_loss_with_uncertainty, ce_loss_with_uncertainty, sigma_regularization, sigmas_regularization
from st2.svhn.datasets import SVHNDataReader, Separator
...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_label", type=int, default=1000)

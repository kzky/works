...
class Experiment028(Experiment026):
    """Regularize hiddnes of decoders with LDS.

    Using strided convolution in Encoder and deconvolution instead of unpooling 
    in Decoder, and regularize between maxpooing and upsample 
    deconvolution.
    """
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, lr_decay=False):
        super(Experiment028, self).__init__(
            device=device,
            learning_rate=learning_rate,
            act=act, 
        )
        ...
        # Model
        from lds.mnist.cnn_model_007 import AutoEncoder
        self.ae = AutoEncoder(act)
        self.ae.to_gpu(device) if self.device else None
...
class Experiment029(Experiment025):
    """Regularize hiddnes of decoders with LDS.
...
class Experiment030(Experiment025):
    """Regularize with reconstruction

    """
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, lr_decay=False):
        super(Experiment030, self).__init__(
            device=device,
            learning_rate=learning_rate,
            act=act, 
        )
...
class Experiment031(Experiment025):
    ...
    """
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, lr_decay=False):
        super(Experiment031, self).__init__(
            device=device,
            learning_rate=learning_rate,
            act=act, 
        )
...
class Experiment032(Experiment025):
    ...
    """
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, lr_decay=False):
        super(Experiment032, self).__init__(
            device=device,
            learning_rate=learning_rate,
            act=act, 
        )
        ...
        # Model
        from lds.mnist.cnn_model_009 import AutoEncoderWithMLP
...
class Experiment033(Experiment025):
    ...
    """
    def __init__(self, device=None, learning_rate=1e-3, act=F.relu, lr_decay=False):
        super(Experiment033, self).__init__(
            device=device,
            learning_rate=learning_rate,
            act=act, 
        )
        ...
        # Model
        from lds.mnist.cnn_model_010 import AutoEncoderWithMLP
        self.ae = AutoEncoderWithMLP(act)
        self.ae.to_gpu(device) if self.device else None

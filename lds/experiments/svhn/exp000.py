from lds.svhn.experiments import Experiment000
from lds.utils import to_device
from lds.svhn.datasets import SVHNDataReader, Separator
import numpy as np
import os
import numpy as np
import sys
...
def main():
    ...
    fpath = os.path.join(home, "datasets/svhn/train_32x32.mat")

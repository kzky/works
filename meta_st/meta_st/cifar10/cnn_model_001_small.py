...
class Model(Chain):
    ...
    def __init__(self, device=None, act=F.leaky_relu):
        ...
        super(Model, self).__init__(
            # ConvBlock0
            conv00=ConvUnit(3, 48, k=3, s=1, p=1),
            conv01=ConvUnit(48, 48, k=3, s=1, p=1),
            conv02=ConvUnit(48, 48, k=3, s=1, p=1),
            bn0=BatchNormalization(48),
            # ConvBlock1
            conv10=ConvUnit(48, 96, k=3, s=1, p=1),
            conv11=ConvUnit(96, 96, k=3, s=1, p=1),
            conv12=ConvUnit(96, 96, k=3, s=1, p=1),
            bn1=BatchNormalization(96),
            # ConvBlock3
            conv20=ConvUnit(96, 96, k=3, s=1, p=0),
            conv21=ConvUnit(96, 96, k=1, s=1, p=0),
            conv22=ConvUnit(96, 10, k=1, s=1, p=0),

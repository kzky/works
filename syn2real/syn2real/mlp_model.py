...
class Encoder(Chain):
    ...
    def __init__(self, act=F.relu):
        super(Encoder, self).__init__(
            linear0=L.Linear(784, 500, wscale=1./784),
            linear1=L.Linear(500, 250, wscale=1./500),
            linear2=L.Linear(250, 100, wscale=1./250),
            linear3=L.Linear(100, 10, wscale=1./100),
...
class Decoder(Chain):
    ...
    def __init__(self, act=F.relu):
        ...
        super(Decoder, self).__init__(
            linear0=L.Linear(10, 100, wscale=1./10),
            linear1=L.Linear(100, 250, wscale=1./100),
            linear2=L.Linear(250, 500, wscale=1./250),
            linear3=L.Linear(500, 784, wscale=1./500),
...
class Generator(Chain):
    ...
    def __init__(self, act=F.relu):
        super(Generator, self).__init__(
            linear0=L.Linear(784+100, 500, wscale=1./(784+100)),
            linear1=L.Linear(500, 250, wscale=1./500),
            linear2=L.Linear(250, 500, wscale=1./250),
            linear3=L.Linear(500, 784, wscale=1./500),
            bn0=L.BatchNormalization(500, decay=0.9),
...
class Discriminator(Chain):
    ...
    def __init__(self, act=F.relu):
        super(Discriminator, self).__init__(
            ...
            linear1=L.Linear(500, 250, wscale=1./500),
            linear2=L.Linear(250, 100, wscale=1./250),
            linear3=L.Linear(100, 1, wscale=1./100),
            bn0=L.BatchNormalization(500, decay=0.9),
            bn1=L.BatchNormalization(250, decay=0.9),
            bn2=L.BatchNormalization(100, decay=0.9),
        )

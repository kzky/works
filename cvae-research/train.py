...
from models import encoder, decoder, infer, loss_recon, loss_kl, loss_fft, loss_edge
...
def train(args):
    ...
    monitor_edge_loss = MonitorSeries("Edge Loss", monitor, interval=10)
    ...
    edge_loss = loss_edge(x_recon, x, level=1).apply(persistent=True)
    loss = recon_loss + kl_loss + edge_loss
    ...
    for i in range(args.max_iter):
        ...
        monitor_edge_loss.add(i, edge_loss.d)
        monitor_time.add(i)

"""Experiments
"""
from da_recon4.models import MLPModel
...
class Experiment(object):
    ...
    def __init__(self,
        ...
        # Loss
        self.v_loss_data = None
        self.recon_loss_data = None
        self.recon_feet_loss_data = None
    ...
    def forward_for_loss(self, x, x_recon, x_gen):
        ...
        self.recon_feet_loss_data = cuda.to_cpu(recon_feet_loss.data)

...
class Decoder(Chain, Mixin):
    def __init__(self, device=None, act=F.relu, ):
        super(Decoder, self).__init__(
            deconv0=L.Deconvolution2D(128, 64, ksize=1, stride=1, pad=0, ),
            deconv1=L.Deconvolution2D(64, 32, ksize=4, stride=2, pad=1, ),
            deconv2=L.Deconvolution2D(32, 1, ksize=4, stride=2, pad=1, ),

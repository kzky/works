...
class Model(Chain):
    ...
    def __init__(self, device=None, act=F.leaky_relu):
        ...
        super(Model, self).__init__(
            # ConvBlock0
            conv00=ConvUnit(3, 128, k=3, s=1, p=1),
            conv01=ConvUnit(128, 128, k=3, s=1, p=1),
            conv02=ConvUnit(128, 128, k=3, s=1, p=1),
            bn0=L.BatchNormalization(128),
            # ConvBlock1
            conv10=ConvUnit(128, 256, k=3, s=1, p=1),
            conv11=ConvUnit(256, 256, k=3, s=1, p=1),
            conv12=ConvUnit(256, 256, k=3, s=1, p=1),
            bn1=L.BatchNormalization(256),
            # ConvBlock3
            conv20=ConvUnit(256, 512, k=3, s=1, p=0),
            conv21=ConvUnit(512, 256, k=1, s=1, p=0),
            conv22=ConvUnit(256, 128, k=1, s=1, p=0),
            conv23=ConvUnit(128, 10, k=1, s=1, p=0),
    ...
    def __call__(self, x, test=False):
        ...
        with cuda.get_device_from_id(self.device):
            noise = xp.random.randn(*x.shape) * 0.015
            x.data += noise
